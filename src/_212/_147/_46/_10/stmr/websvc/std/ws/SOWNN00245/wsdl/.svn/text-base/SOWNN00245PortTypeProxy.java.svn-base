...
public class SOWNN00245PortTypeProxy implements _212._147._46._10.stmr.websvc.std.ws.SOWNN00245.wsdl.SOWNN00245PortType {
  private String _endpoint = null;
  private _212._147._46._10.stmr.websvc.std.ws.SOWNN00245.wsdl.SOWNN00245PortType sOWNN00245PortType = null;
  ...
  private void _initSOWNN00245PortTypeProxy() {
    try {
      sOWNN00245PortType = (new _212._147._46._10.stmr.websvc.std.ws.SOWNN00245.wsdl.SOWNN00245ServiceLocator()).getSOWNN00245Port();
  ...
  public _212._147._46._10.stmr.websvc.std.ws.SOWNN00245.wsdl.SOWNN00245PortType getSOWNN00245PortType() {
    if (sOWNN00245PortType == null)
      _initSOWNN00245PortTypeProxy();
