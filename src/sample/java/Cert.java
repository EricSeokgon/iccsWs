...
public class Cert {
	...
	void view() {
		...
		try {
			...
			X509Certificate x509Cert = Disk.readCert(Util.rootpath + "Sample/CERT/viewCert.der");
	...
	void verify() {
		...
		try {
			certPathValiditor = new CertPathValidator(Util.rootpath + "gpkiapi.conf");
			
			X509Certificate rootCert = Disk.readCert(Util.rootpath + "Sample/CERT/KISA.der");
			
			//X509Certificate myCert = Disk.readCert(Util.rootpath + "Sample/CERT/001권한용001_sig.der");
			//PrivateKey myPrikey = Disk.readPriKey(Util.rootpath + "Sample/CERT/001권한용001_sig.key", "1111");
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/gpkiCert.cer");
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/yessignCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/tradesignCert.der");
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/signkoreaCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/kicaCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/crossCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
		...
		try {
			...
			cert = Disk.readCert(Util.rootpath + "Sample/CERT/ncasignCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
	...
	void verifyVID() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert(Util.rootpath + "Sample/CERT/vidCert.der");
			PrivateKey prikey = Disk.readPriKey(Util.rootpath + "Sample/CERT/vidPri.key", "88888888");
	...
	void checkStatus() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert(Util.rootpath + "Sample/CERT/vidCert.der");
			X509Certificate myCert = Disk.readCert(Util.rootpath + "Sample/CERT/vidCert.der");
			PrivateKey myPriKey = Disk.readPriKey(Util.rootpath + "Sample/CERT/vidPri.key", "88888888");
			...
			Disk.write(Util.rootpath + "Sample/CERT/ocspReqMsg.ber", reqMsg);
			
			byte[] resMsg;
			resMsg = Disk.read(Util.rootpath + "Sample/CERT/ocspResMsg.ber");
