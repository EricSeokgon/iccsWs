...
public class Tsa {
	...
	public void reqTimeStamp() {
		...
		try {
			...
			message = Disk.read(Util.rootpath + "Sample/TSA/Message.txt");
			...
			Disk.write(Util.rootpath + "Sample/TSA/Message.tst", timeStampToken.getTimeStampToken());
			...
			byte[] resMsg = Disk.read(Util.rootpath + "Sample/TSA/TimeStampRes_nok.ber");
