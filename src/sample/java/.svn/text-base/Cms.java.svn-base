...
public class Cms {
	...
	public Cms(boolean bPrintLog) {
		...
		try {
			...
			plainText = Disk.read(Util.rootpath + "Sample/CMS/plainText.txt");
		} catch (Exception e) {
			e.printStackTrace();
			nErrCnt++;		
		}
	...
	public void signData() {
		...
		try {
			...
			signerCert1 = Disk.readCert(Util.rootpath + "Sample/CMS/signCert1.der");
			signerPriKey1 = Disk.readPriKey(Util.rootpath + "Sample/CMS/signPri1.key", "1111");
			
			signerCert2 = Disk.readCert(Util.rootpath + "Sample/CMS/signCert2.der");
			signerPriKey2 = Disk.readPriKey(Util.rootpath + "Sample/CMS/signPri2.key", "qwer1234");
			...
			signedData.setMessage_File(Util.rootpath + "Sample/CMS/plainText_File.txt");
			signedData.generate_File(signerCert1, signerPriKey1, Util.rootpath + "Sample/CMS/SignedData_File.ber");
			System.out.println("  ... ok");
			...
			//Disk.write(Util.rootpath + "Sample/CMS/SignedData.ber", outData);
			...
			outData = Disk.read(Util.rootpath + "Sample/CMS/SignedData.ber");
			...
			signedData.verify_File(Util.rootpath + "Sample/CMS/SignedData_File.ber", Util.rootpath + "Sample/CMS/message_File.txt");
	...
	void envData() {
		...
		try {
			...
			recCert1 = Disk.readCert(Util.rootpath + "Sample/CMS/kmCert1.der");
			recPriKey1 = Disk.readPriKey(Util.rootpath + "Sample/CMS/kmPri1.key", "1111");
			
			recCert2 = Disk.readCert(Util.rootpath + "Sample/CMS/kmCert2.der");
			recPriKey2 = Disk.readPriKey(Util.rootpath + "Sample/CMS/kmPri2.key", "qwer1234");
			...
			envData.generate_File(Util.rootpath + "Sample/CMS/plainText_File.txt", Util.rootpath + "Sample/CMS/envData_File.ber");
			...
			//Disk.write(Util.rootpath + "Sample/CMS/EnvelopedData.ber", outData);
			...
			outData = Disk.read(Util.rootpath + "Sample/CMS/EnvelopedData.ber");
			...
			msg = envData.process_File(Util.rootpath + "Sample/CMS/EnvData_File.ber", recCert1, recPriKey1, Util.rootpath + "Sample/CMS/Messsage_File.txt");
	...
	void signedAndEnvData() {
		...
		try {
			...
			signerCert = Disk.readCert(Util.rootpath + "Sample/CMS/signCert1.der");
			signerKey = Disk.readPriKey(Util.rootpath + "Sample/CMS/signPri1.key", "1111");
			
			kmCert = Disk.readCert(Util.rootpath + "Sample/CMS/kmCert1.der");
			kmKey = Disk.readPriKey(Util.rootpath + "Sample/CMS/kmPri1.key", "1111");
			...
			Disk.write(Util.rootpath + "Sample/CMS/signedAndEnvData.ber", outData);
			...
			//Disk.write(Util.rootpath + "Sample/CMS/aaa.txt", outData);
	...
	void signedContent() {
		...
		try {
			...
			signerCert = Disk.readCert(Util.rootpath + "Sample/CMS/signCert3.der");
			signerPriKey = Disk.readPriKey(Util.rootpath + "Sample/CMS/signPri3.key", "88888888");
			...
			//Disk.write(Util.rootpath + "Sample/CMS/SignedContent.xdr", outData);
			...
			System.out.print("  - Compatibility");
			outData = Disk.read(Util.rootpath + "Sample/CMS/SignedContent.xdr");
	...
	void wapEnvData() {
		...
		try {
			...
			recCert = Disk.readCert(Util.rootpath + "Sample/CMS/kmCert1.der");
			recPriKey = Disk.readPriKey(Util.rootpath + "Sample/CMS/kmPri1.key", "1111");
			...
			//Disk.write(Util.rootpath + "Sample/CMS/WapEnvelopedData.xdr", outData);
			...
			System.out.print("  - Compatibility");
			outData = Disk.read(Util.rootpath + "Sample/CMS/WapEnvelopedData.xdr");
